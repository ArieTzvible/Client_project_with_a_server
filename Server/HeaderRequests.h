...
int test_function(PNode root, void* value, char opr, int (*testing)(void*, PClient), char** buffer);//Sorting and printing function according to the request
void adding_client_from_user(ListManager* list, char* received_buffer);//Print a new line from the user to the file
